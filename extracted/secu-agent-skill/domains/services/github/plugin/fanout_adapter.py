"""Core plugin adapter for GitHub E2E fanout registration."""
from __future__ import annotations

from domains.services.github.application.fanout import (
    FanoutServices,
    register as register_application_fanout,
)
from domains.services.github.infrastructure.runtime import (
...
def register() -> bool:
    services = FanoutServices(
        ...
        quality=QualityRecorder("github"),
    )
