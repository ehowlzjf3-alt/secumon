...
const evidence = join(root, 'evidence-clone');
...
try {
  ...
  if (record.buildPin.sourceDigest !== 'fee85e7d0de7caa73c40491b231b1c65edbe2250c029ec23a95254b493a5da1a') throw new Error('source_pin_mismatch');
  await run('portability-targeted', process.execPath, ['--test', '--test-concurrency=2', '--test-reporter=tap',
    'dist/tests/agent-clone.test.js', 'dist/tests/agent-clone-recovery.test.js', 'dist/tests/local-file-paths.test.js', 'dist/tests/agent-profile.test.js', 'dist/tests/agent-stores.test.js', 'dist/tests/cli.test.js', 'dist/tests/mcp-read-tools.test.js', 'dist/tests/mcp-stdio-client.test.js', 'dist/tests/state-query.test.js']);
  ...
  if (JSON.stringify(record.buildPin) !== JSON.stringify({"sourceDigest":"fee85e7d0de7caa73c40491b231b1c65edbe2250c029ec23a95254b493a5da1a","filesDigest":"c645b1ac1df1d3612df294e2fc20a43f535908d66047a9de36a4c15fcb7a504e","fileCount":1035})) throw new Error('final_build_pin_mismatch');
