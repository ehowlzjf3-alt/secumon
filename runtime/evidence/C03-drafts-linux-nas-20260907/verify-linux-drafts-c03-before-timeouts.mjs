...
try {
  ...
  record.targeted={discovery:'same_33_files_as_local_targeted_run',files:targeted,fileCount:targeted.length,testCount:null};persist();
  await run('drafts-targeted',process.execPath,['--test','--test-concurrency=2','--test-reporter=tap',...targeted]);
