...
import { directory, root, assertPin, controlPath } from './migration-c03-common.mjs';
...
const get = name => execFileSync('ssh', ['-S', control.socket, 'nas', '/bin/cat ' + root + '/evidence-migration-c03/' + name], { timeout: 30000, maxBuffer: 32 * 1024 * 1024 });
...
const allowed = new Set(['build', 'migration-new', 'migration-related', 'typecheck-core', 'architecture', 'architecture-cli-fixtures', 'all-tests', 'fixtures']);
