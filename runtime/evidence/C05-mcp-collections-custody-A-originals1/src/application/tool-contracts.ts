...
import { z } from 'zod';
import type { ReadDeferralProofInput, ReadPageProofInput, ReadResponseRestoreInput, ReadResponseRestoreResult, SchemaCompiler, StoredToolResult, StoredToolResultInput, StoredToolUsage, Tool } from './ports.js';
import { ReadKeySchema, ReadResponseSchema } from './read-collection-contracts.js';
...
export function snapshotTool(tool: Tool): Tool {
  ...
  const readManifest = tool?.readManifest;
