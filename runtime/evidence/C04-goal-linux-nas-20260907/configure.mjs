...
assert.equal(previousNativeResult, 'evidence-registered-c04/result.json', 'goal change validation reuses the completed registered-model dedicated root');
...
const configPath = join(directory, 'goal-c04-config.json'), controlPath = join(directory, 'control-directory.txt');
