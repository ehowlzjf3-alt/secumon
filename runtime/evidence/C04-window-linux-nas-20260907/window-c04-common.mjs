...
export const directory = 'evidence/C04-window-linux-nas-20260907';
export const configuration = JSON.parse(readFileSync(new URL('./window-c04-config.json', import.meta.url), 'utf8'));
...
assert.equal(configuration.previousNativeResult, 'evidence-turn-c04/result.json');
