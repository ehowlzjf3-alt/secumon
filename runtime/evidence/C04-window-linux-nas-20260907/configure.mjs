...
assert.equal(previousNativeResult, 'evidence-turn-c04/result.json', 'window validation reuses the completed turn dedicated root');
...
const configPath = join(directory, 'window-c04-config.json'), controlPath = join(directory, 'control-directory.txt');
