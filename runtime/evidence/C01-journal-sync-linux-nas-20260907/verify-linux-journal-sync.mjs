...
const evidence = join(root, 'evidence-journal-sync');
...
try {
  ...
  if (record.buildPin.sourceDigest !== '07bc725fa221ab3f9b9932d90044a44174c08f117795c7e0427d5bb388e37899') throw new Error('source_pin_mismatch');
  await run('sync-targeted', process.execPath, ["--test","--test-concurrency=2","--test-reporter=tap","dist/tests/journal-directory-boundary.test.js","dist/tests/journal-directory-race.test.js","dist/tests/journal-sync-boundary.test.js","dist/tests/host-metadata-sync.test.js","dist/tests/journal-fault.test.js","dist/tests/journal-owner.test.js","dist/tests/state-conformance.test.js","dist/tests/state-query.test.js","dist/tests/agent-backend-binding.test.js","dist/tests/host-metadata-files.test.js","dist/tests/metadata-wrapper.test.js"]);
  ...
  if (JSON.stringify(record.buildPin) !== JSON.stringify({"sourceDigest":"07bc725fa221ab3f9b9932d90044a44174c08f117795c7e0427d5bb388e37899","filesDigest":"269e60def932d32739e12f3ac1c241832bb80bf1c1e8018ca7444ac104b011a0","fileCount":1113})) throw new Error('final_build_pin_mismatch');
