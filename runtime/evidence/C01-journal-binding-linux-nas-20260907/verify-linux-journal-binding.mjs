...
const evidence = join(root, 'evidence-journal-binding');
...
try {
  ...
  if (JSON.stringify(record.buildPin) !== JSON.stringify({"sourceDigest":"80a2d62de7204e09a82e53dbf24a3e9e02cab00899f68dd59ade42fd9e848b80","filesDigest":"6acbc8d1a3c801fe85ea36e2ffd11789c92b529fab1b3cb25fd5d66cef0ea10b","fileCount":1065})) throw new Error('final_build_pin_mismatch');
