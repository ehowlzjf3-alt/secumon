...
const evidence = join(root, 'evidence-metadata-boundary');
...
try {
  ...
  if (record.buildPin.sourceDigest !== '19d00585bc77e36ea6c077777b51eb02f9231ada99bd27afad75ad4f4564a2d9') throw new Error('source_pin_mismatch');
  await run('metadata-targeted', process.execPath, ["--test","--test-concurrency=2","--test-reporter=tap","dist/tests/host-metadata-files.test.js","dist/tests/metadata-wrapper.test.js","dist/tests/agent-profile-concurrency.test.js","dist/tests/agent-backend-binding.test.js","dist/tests/agent-state-binding-recovery.test.js","dist/tests/agent-database-owner.test.js","dist/tests/journal-owner.test.js","dist/tests/agent-stores.test.js","dist/tests/state-conformance.test.js","dist/tests/journal-fault.test.js","dist/tests/state-profile.test.js","dist/tests/state-query.test.js","dist/tests/agent-clone.test.js","dist/tests/agent-clone-recovery.test.js","dist/tests/agent-profile.test.js","dist/tests/cli.test.js"]);
  ...
  if (JSON.stringify(record.buildPin) !== JSON.stringify({"sourceDigest":"19d00585bc77e36ea6c077777b51eb02f9231ada99bd27afad75ad4f4564a2d9","filesDigest":"489027e6df022b14e1b2ac30f4f231ded8547208e91d771a3299f7696f40922d","fileCount":1086})) throw new Error('final_build_pin_mismatch');
