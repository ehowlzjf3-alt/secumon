...
const result = { schemaVersion: 1, chapter: 'C05', scope: 'mcp_offline_general_resume',
  ...
  limitations: ['No real model/API, Knox/internal-service integration, or production deployment was tested.',
    ...
    'The actual offline CLI fixture restores a stored plain-read response; the HTTP fixture waits for a connection before an uncalled task. Other interruption and reconnect boundaries require their own tests.',
