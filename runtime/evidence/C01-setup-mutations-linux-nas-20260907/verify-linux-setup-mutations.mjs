...
const evidence = join(root, 'evidence-setup-mutations');
const expectedPin = JSON.parse(readFileSync(join(root, 'setup-mutations-build-pin.json'), 'utf8')); 
...
try {
  ...
  await run('setup-targeted', process.execPath, ["--test","--test-concurrency=2","--test-reporter=tap","dist/tests/host-file-mutations.test.js","dist/tests/agent-setup-mutations.test.js","dist/tests/agent-profile.test.js","dist/tests/agent-profile-concurrency.test.js","dist/tests/agent-clone.test.js","dist/tests/agent-clone-recovery.test.js","dist/tests/agent-stores.test.js","dist/tests/agent-backend-binding.test.js","dist/tests/metadata-wrapper.test.js","dist/tests/host-metadata-files.test.js","dist/tests/host-metadata-sync.test.js"]);
