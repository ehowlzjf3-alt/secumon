...
const evidence = join(root, 'evidence-confirmed');
...
try {
  ...
  if (record.buildPin.sourceDigest !== '987e6cc8d2e22d1cef9606af7eba69f8a297f34e58e23cb8efc91b4cb5fa5709') throw new Error('source_pin_mismatch');
