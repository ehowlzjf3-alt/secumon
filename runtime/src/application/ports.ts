...
export type ReadResponseRestoreResult = { kind: 'absent' } |
  { kind: 'custody_only'; reason: 'captured' | 'failure' | 'late_returned' } |
  { kind: 'available'; response: ReadResponse; receivedAt: number };
...
export interface MessageSink {
  ...
  /** Composite sinks can preserve the retry guarantee of the selected route. */
  canRetryAbsent?(delivery: Delivery): boolean;
