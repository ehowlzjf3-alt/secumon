...
export const ConversationBindingSchema = z.strictObject({ id, channel: z.enum(['cli', 'web', 'knox', 'test', 'peer']), conversationId: id, recipientId: id, destination: id, tenantId: id, principalId: id, session: SessionScopeSchema.optional() });
